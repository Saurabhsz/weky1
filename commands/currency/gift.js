...
const dat = require('../../schemas/inventory')
const data = dat.findOne({ User: message.author.id })
if(data[validName] < num) {return message.reply(`You dont have ${num} ${realItem} bruh`)}else{
