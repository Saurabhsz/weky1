...
if(useArgs[0] === 'laptop'){
    ...
    .addField(`${message.author.username} Owns: ${ata.Laptop}\n`,
               `Cost: \`4,000\`\n
                Sell: \`1,000\`\n
               ID: \`laptop\`\n\n
...
if(useArgs[0] === 'script' || useArgs[0] === 'space'){
    ...
    .addField(`${message.author.username} Owns: ${ata.SpaceScript}\n`,
                     `Cost: \`NON BUYABLE\`\n
                     Sell: \`1,000\`\n
                     ID: \`spacescript\`\n\n
...
if(useArgs[0] === 'moon' || useArgs[0] === 'wekymoon'){
    ...
    .addField(`${message.author.username} Owns: ${ata.WekyMoon}\n`,
                     `Cost: \`2,000,000\`\n
                     Sell: \`NON SELLABLE\`\n
                     ID: \`wekymoon\`\n\n
...
if(useArgs[0] === 'ripoff' || useArgs[0] === 'wekyrip' || useArgs[0] === 'wekyoff'){
  ...
  .addField(`${message.author.username} Owns: ${ata.WekyRipOff}\n`,
             `Cost: \`12,000,000\`\n
             Sell: \`NON SELLABLE\`\n
             ID: \`wekyrip\`\n\n
             Description: This item is used to flex on the kids who can\`t get it`)
...
if(useArgs[0] === 'fi' || useArgs[0] === 'fis' || useArgs[0] === 'fish'){
  ...
  .addField(`${message.author.username} Owns: ${ata.Fish}\n`,
             `Cost: \`NON BUYABLE\`\n
             Sell: \`250\`\n
             ID: \`fish\`\n\n
...
if(useArgs[0] === 'rarefi' || useArgs[0] === 'rareis' || useArgs[0] === 'rarefish'){
  ...
  .addField(`${message.author.username} Owns: ${ata.RareFish}\n`,
             `Cost: \`NON BUYABLE\`\n
             Sell: \`500\`\n
             ID: \`rarefish\`\n\n
             Description: You get these fishy fishes by fishing with your Plastic Hand lol? lol!`)
...
if(useArgs[0] === 'hand' || useArgs[0] === 'plastichand' || useArgs[0] === 'handplastic' || useArgs[0] === 'plastic'){
  ...
  .addField(`${message.author.username} Owns: ${ata.PlasticHand}\n`,
             `Cost: \`15,000\`\n
             Sell: \`1,500\`\n
             ID: \`hand\`\n\n
...
if(useArgs[0] === 'gotcha' || useArgs[0] === 'gotchabox'){
  ...
  .addField(`${message.author.username} Owns: ${ata.GotchaBox}\n`,
             `Cost: \`NON BUYABLE\`\n
              Sell: \`NON SELLABLE\`\n
             ID: \`gotcha\`\n\n
...
if(useArgs[0] === 'silver' || useArgs[0] === 'silvermoon'){
  ...
  .addField(`${message.author.username} Owns: ${ata.SilverMoon}\n`,
             `Cost: \`NON BUYABLE\`\n
              Sell: \`NON SELLABLE\`\n
             ID: \`silver\`\n\n
...
if(useArgs[0] === 'sniper'){
  ...
  .addField(`${message.author.username} Owns: ${ata.Sniper}\n`,
             `Cost: \`15,000\`\n
              Sell: \`1,500\`\n
             ID: \`sniper\`\n\n
...
if(useArgs[0] === 'fox'){
  ...
  .addField(`${message.author.username} Owns:${ata.Fox}}\n`,
             `Cost: \`NON BUYABLE\`\n
              Sell: \`50\`\n
             ID: \`laptop\`\n\n
...
if(useArgs[0] === 'tiger'){
  ...
  .addField(`${message.author.username} Owns: ${ata.Tiger}\n`,
             `Cost: \`NON BUYABLE\`\n
              Sell: \`200\`\n
             ID: \`tiger\`\n\n
             Description: This item can just be sold, wow`)
...
if(useArgs[0] === 'eagle'){
  ...
  .addField(`${message.author.username} Owns: ${ata.Eagle}\n`,
             `Cost: \`NON BUYABLE\`\n
              Sell: \`500\`\n
             ID: \`eagle\`\n\n
             Description: This item can just be sold, wow`)
...
if(useArgs[0] === 'bear'){
  ...
  .addField(`${message.author.username} Owns: ${ata.Bear}\n`,
             `Cost: \`NON BUYABLE\`\n
              Sell: \`1,200\`\n
             ID: \`bear\`\n\n
             Description: This item can just be sold, wow`)
...
if(useArgs[0] === 'leg' || useArgs[0] === 'legendary' || useArgs[0] === 'legendaryfish'){
  ...
  .addField(`${message.author.username} Owns: ${ata.LegendaryFish}\n`,
                   `Cost: \`NON BUYABLE\`\n
                   Sell: \`15,000\`\n
                   ID: \`legendary\`\n\n
                   Description: This item can just be sold, wow`)
...
if(useArgs[0] === 'facebut' || useArgs[0] === 'face' || useArgs[0] === 'facebutlie'){
  ...
  .addField(`${message.author.username} Owns: ${ata.FaceButLie}\n`,
                   `Cost: \`NON BUYABLE\`\n
                   Sell: \`200,000\`\n
                   ID: \`facebutlie\`\n\n
                   Description: :joy:`)
...
if(useArgs[0] === 'life' || useArgs[0] === 'shield' || useArgs[0] === 'lifeshield'){
  ...
  .addField(`${message.author.username} Owns: ${ata.LifeShield}\n`,
                   `Cost: \`14,000\`\n
                   Sell: \`1,400\`\n
                   ID: \`life\`\n\n
...
if(useArgs[0] === 'bread' || useArgs[0] === 'bd'){
  ...
  .addField(`${message.author.username} Owns: ${ata.Bread}\n`,
                   `Cost: \`15,000\`\n
                   Sell: \`NON SELLABLE\`\n
                   ID: \`bread\`\n\n
...
if(useArgs[0] === 'energydrink' || useArgs[0] === 'energy' || useArgs[0] === 'drink'){
  ...
  .addField(`${message.author.username} Owns: ${ata.EnergyDrink}\n`,
                   `Cost: \`20,000\`\n
                   Sell: \`2,000\`\n
                   ID: \`bread\`\n\n
...
if(useArgs[0] === 'sun' || useArgs[0] === 'glasses' || useArgs[0] === 'sunglasses'){
  ...
  .addField(`${message.author.username} Owns: ${ata.SunGlasses}\n`,
                   `Cost: \`10\`\n
                   Sell: \`NON SELLABLE\`\n
                   ID: \`sunglasses\`\n\n
...
if(useArgs[0] === 'booster'){
  ...
  .addField(`${message.author.username} Owns: ${ata.Booster}\n`,
                   `Cost: \`1000\`\n
                   Sell: \`NON SELLABLE\`\n
                   ID: \`booster\`\n\n
...
if(useArgs[0] === 'slice' || useArgs[0] === 'sliceof' || useArgs[0] === 'sliceoftomato'||useArgs[0] === 'tomato' ){
  ...
  .addField(`${message.author.username} Owns: ${ata.SliceOfTomato}\n`,
                   `Cost: \`NON BUYABLE\`\n
                   Sell: \`75,000\`\n
                   ID: \`slice\`\n\n
...
if(useArgs[0] === 'common' || useArgs[0] === 'commonbox'){
  ...
  .addField(`${message.author.username} Owns: ${ata.CommonBox}\n`,
                   `Cost: \`NON BUYABLE\`\n
                   Sell: \`NON SELLABLE\`\n
                   ID: \`commonbox\`\n\n
