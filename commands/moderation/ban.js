...
module.exports = {
  ...
  async execute(bot, message, args) {
    ...
    if(message.mentions.members.first().roles.highest.position > user.roles.highest.position)return message.channel.send("Your highest role is lower than the mentioned user's role");
