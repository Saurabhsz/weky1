...
module.exports.run = async (bot, message, args) => {
        const { MessageEmbed, Message } = require("discord.js");
            ...
            .addField(`[RULE 2](https://discord.com/oauth2/authorize?client_id=809496186905165834&scope=bot&permissions=2083912822)
                       \n\`Raiding\`\nDon't use the bot for a raid of commands or for a spam with the echo commands.`)
             .addField(`[RULE 3](https://discord.com/oauth2/authorize?client_id=809496186905165834&scope=bot&permissions=2083912822)
                       \n\`Scripts, Auto Grind\`\nSelf bots, scripts
             ...
             .addField(`[RULE 4](https://discord.com/oauth2/authorize?client_id=809496186905165834&scope=bot&permissions=2083912822)
                       \n\`Real money trading\`\nNo items or anything from our currency selling for real things or money.`)
             .addField(`[RULE 5](https://discord.com/oauth2/authorize?client_id=809496186905165834&scope=bot&permissions=2083912822)
