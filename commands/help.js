...
module.exports.run = async (bot, message, args) => {
    ...
    if(!helpArgs[0]) {
        ...
        .setDescription('😂 Fun:\n `corona`, `rc`, `meme`, `simprate`, `ship`, `noobrate`, `fart`, `cringerate`, `snipe`, `8ball`, `avatar`, `google`, `emoji`, `pp`, `trivia`, `ascii`, `reverse`, `say`, `fasttype`, `sudo`, `emojify`\n💰 Currency:\n `beg`, `buy`, `shop`, `dep`, `with`, `daily`, `bet`, `bal`, `use`, `share`, `inventory`, `pog`\n⚒️ Moderation:\n `purge`, `lockdown`, `endlockdown`, `warn`, `warnings`, `ban`\n🔩 Utility:\n `ping`, `invite`, `uptime`, `math`, `poll`, `report`, `serveremoji`, `addemoji`\n📷 Image:\n`drip`, `gray`, `blur`, `facepalm`, `hitler`, `invert`, `gay`, `trigger`, `rip`, `shit`, `trash`, `bird`, `sepia`, `dither`, `80s`, `pet`, `alone`, `muffin`, `toilet`, `turtle` `sock`, `moment`, `doggo`, `awesome`')
        .setColor('#FF2D00')
